---
title: "California Housing — ML Pipeline Case Study"
project: "california-housing-mlops"
---

## Problem & Context

The California Housing dataset is a classic regression benchmark, but most tutorials stop at model training in a notebook. **Real ML engineering begins where notebooks end.** This project demonstrates a complete ML pipeline — from raw data ingestion through automated training, validation, versioning, and serving — using industry-standard tools: MLflow, FastAPI, Docker, GitHub Actions, and Pytest.
